...
## Objective
In this lab, you will practice working with integer arrays, writing methods to manipulate and analyze arrays.

All of the methods below are static methods.  They should be located in the Lab22 class.  I will be testing your methods on my tester code - (not identical to the samples)-however, you must show evidence (in your main method) that you tested your code on different arrays of different sizes.  Push the boundaries!
